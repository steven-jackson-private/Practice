...
<div id="footer">
	...
	<div class="shell">
		...
		<div class="cols">
			<ul>
				...
				<li class="col contact">
					...
					<form  method="get" action="inc/newsletter_signup.php">
						<div class="field-wrapper">
							<input type="text" class="field" value="Name" title="Name" name="name"/>
						</div>
						<div class="field-wrapper">
							<input type="text" class="field" value="Email" title="Email" name="email"/>
						</div>
		...
		<a href="#" class="logo" title="Shopper Friend"><img src="images/footer-logo.png" alt="Shopper Friend" /></a>
		<div class="cl">&nbsp;</div>
	</div>
	<!-- End Shell -->
</div>
